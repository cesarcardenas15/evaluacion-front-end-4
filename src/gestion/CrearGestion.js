...
function CrearGestion() {
    ...
    return (
        <div className="container">
            <h1>Crear Gestión</h1>
            <hr></hr>
            <div className="card-header">Complete los datos para crear el registro</div>
            <div className="card-body">
                <form onSubmit={onSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" maxLength={45} onChange={(e) => setComentarios(e.target.value)}></input>
                    </div>
